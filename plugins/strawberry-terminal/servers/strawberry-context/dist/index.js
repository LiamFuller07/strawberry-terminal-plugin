            ...
            try {
                switch (name) {
                    case 'strawberry_sync': {
                        ...
                        const currentAction = args?.current_action;
                        const currentTool = args?.current_tool;
                        ...
                        if (currentTool && phase === 'tool_use') {
                            ...
                            const existing = this.state.recentTools.find(t => t.name === currentTool && t.status === 'running');
                            if (!existing) {
                                this.state.recentTools = [
                                    {
                                        name: currentTool,
